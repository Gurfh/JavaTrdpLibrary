...
- **`network`** — `UdpTransport` (with multicast group management, TTL/QoS socket options), `TcpTransport` (client/server with connection pooling, bind address/traffic class support).
